 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myOcl.impl.IndexExpCSImpl#getFirstIndexes <em>First Indexes</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myOcl.impl.IndexExpCSImpl#getSecondIndexes <em>Second Indexes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IndexExpCSImpl extends NavigatingExpCS_BaseImpl implements IndexExpCS
{
  ...
  {
    return MyOclPackage.Literals.INDEX_EXP_CS;
  }
  ...
  public EList<ExpCS> getFirstIndexes()
  {
    ...
    {
      firstIndexes = new EObjectContainmentEList<ExpCS>(ExpCS.class, this, MyOclPackage.INDEX_EXP_CS__FIRST_INDEXES);
    }
    return firstIndexes;
  }
  ...
  public EList<ExpCS> getSecondIndexes()
  {
    ...
    {
      secondIndexes = new EObjectContainmentEList<ExpCS>(ExpCS.class, this, MyOclPackage.INDEX_EXP_CS__SECOND_INDEXES);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyOclPackage.INDEX_EXP_CS__FIRST_INDEXES:
        return ((InternalEList<?>)getFirstIndexes()).basicRemove(otherEnd, msgs);
      case MyOclPackage.INDEX_EXP_CS__SECOND_INDEXES:
