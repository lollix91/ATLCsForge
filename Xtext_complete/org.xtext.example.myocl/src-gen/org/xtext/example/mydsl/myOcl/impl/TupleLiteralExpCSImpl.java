 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myOcl.impl.TupleLiteralExpCSImpl#getOwnedParts <em>Owned Parts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TupleLiteralExpCSImpl extends PrimaryExpCSImpl implements TupleLiteralExpCS
{
  ...
  {
    return MyOclPackage.Literals.TUPLE_LITERAL_EXP_CS;
  }
  ...
  public EList<TupleLiteralPartCS> getOwnedParts()
  {
    if (ownedParts == null)
    {
      ownedParts = new EObjectContainmentEList<TupleLiteralPartCS>(TupleLiteralPartCS.class, this, MyOclPackage.TUPLE_LITERAL_EXP_CS__OWNED_PARTS);
    }
    return ownedParts;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyOclPackage.TUPLE_LITERAL_EXP_CS__OWNED_PARTS:
