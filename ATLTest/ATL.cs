...
START Unit,Library,Query,Module,org.eclipse.m2m.atl.common.OCL.OclFeatureDefinition,org.eclipse.m2m.atl.common.OCL.OclModel


IMPORTS {
	org.eclipse.m2m.atl.common.OCL:<http://www.eclipse.org/gmt/2005/OCL>
	org.eclipse.m2m.atl.common.PrimitiveTypes:<http://www.eclipse.org/gmt/2005/ATL-PrimitiveTypes>
}
...
RULES {
	...
	org.eclipse.m2m.atl.common.OCL.TuplePart ::= "TuplePart" "{" ("location" ":" location['"','"'] | "commentsBefore" ":" commentsBefore[] | "commentsAfter" ":" commentsAfter[] | "id" ":" id['"','"'] | "varName" ":" varName['"','"'] | "type" ":" type | "initExpression" ":" initExpression | "letExp" ":" letExp[] | "baseExp" ":" baseExp[] | "variableExp" ":" variableExp[] | "tuple" ":" tuple[])* "}";
	org.eclipse.m2m.atl.common.OCL.MapExp ::= "MapExp" "{" ("location" ":" location['"','"'] | "commentsBefore" ":" commentsBefore[] | "commentsAfter" ":" commentsAfter[] | "type" ":" type | "ifExp3" ":" ifExp3[] | "appliedProperty" ":" appliedProperty[] | "collection" ":" collection[] | "letExp" ":" letExp[] | "loopExp" ":" loopExp[] | "parentOperation" ":" parentOperation[] | "initializedVariable" ":" initializedVariable[] | "ifExp2" ":" ifExp2[] | "owningOperation" ":" owningOperation[] | "ifExp1" ":" ifExp1[] | "owningAttribute" ":" owningAttribute[] | "elements" ":" elements)* "}";
	org.eclipse.m2m.atl.common.OCL.MapElement ::= "MapElement" "{" ("location" ":" location['"','"'] | "commentsBefore" ":" commentsBefore[] | "commentsAfter" ":" commentsAfter[] | "map" ":" map[] | "key" ":" key | "value" ":" value)* "}";
	...
	org.eclipse.m2m.atl.common.OCL.VariableDeclaration ::= "VariableDeclaration" "{" ("location" ":" location['"','"'] | "commentsBefore" ":" commentsBefore[] | "commentsAfter" ":" commentsAfter[] | "id" ":" id['"','"'] | "varName" ":" varName['"','"'] | "type" ":" type | "initExpression" ":" initExpression | "letExp" ":" letExp[] | "baseExp" ":" baseExp[] | "variableExp" ":" variableExp[])* "}";
	org.eclipse.m2m.atl.common.OCL.Iterator ::= "Iterator" "{" ("location" ":" location['"','"'] | "commentsBefore" ":" commentsBefore[] | "commentsAfter" ":" commentsAfter[] | "id" ":" id['"','"'] | "varName" ":" varName['"','"'] | "type" ":" type | "initExpression" ":" initExpression | "letExp" ":" letExp[] | "baseExp" ":" baseExp[] | "variableExp" ":" variableExp[] | "loopExpr" ":" loopExpr[])* "}";
	org.eclipse.m2m.atl.common.OCL.Parameter ::= "Parameter" "{" ("location" ":" location['"','"'] | "commentsBefore" ":" commentsBefore[] | "commentsAfter" ":" commentsAfter[] | "id" ":" id['"','"'] | "varName" ":" varName['"','"'] | "type" ":" type | "initExpression" ":" initExpression | "letExp" ":" letExp[] | "baseExp" ":" baseExp[] | "variableExp" ":" variableExp[] | "operation" ":" operation[])* "}";
	...
	org.eclipse.m2m.atl.common.OCL.TupleTypeAttribute ::= "TupleTypeAttribute" "{" ("location" ":" location['"','"'] | "commentsBefore" ":" commentsBefore[] | "commentsAfter" ":" commentsAfter[] | "type" ":" type | "tupleType" ":" tupleType[] | "name" ":" name['"','"'])* "}";
	...
	org.eclipse.m2m.atl.common.OCL.OclFeatureDefinition ::= "OclFeatureDefinition" "{" ("location" ":" location['"','"'] | "commentsBefore" ":" commentsBefore[] | "commentsAfter" ":" commentsAfter[] | "feature" ":" feature | "context_" ":" context_)* "}";
	org.eclipse.m2m.atl.common.OCL.OclContextDefinition ::= "OclContextDefinition" "{" ("location" ":" location['"','"'] | "commentsBefore" ":" commentsBefore[] | "commentsAfter" ":" commentsAfter[] | "definition" ":" definition[] | "context_" ":" context_)* "}";
	org.eclipse.m2m.atl.common.OCL.Attribute ::= "Attribute" "{" ("location" ":" location['"','"'] | "commentsBefore" ":" commentsBefore[] | "commentsAfter" ":" commentsAfter[] | "definition" ":" definition[] | "name" ":" name['"','"'] | "initExpression" ":" initExpression | "type" ":" type)* "}";
	org.eclipse.m2m.atl.common.OCL.Operation ::= "Operation" "{" ("location" ":" location['"','"'] | "commentsBefore" ":" commentsBefore[] | "commentsAfter" ":" commentsAfter[] | "definition" ":" definition[] | "name" ":" name['"','"'] | "parameters" ":" parameters | "returnType" ":" returnType | "body" ":" body)* "}";
	org.eclipse.m2m.atl.common.OCL.OclModel ::= "OclModel" "{" ("location" ":" location['"','"'] | "commentsBefore" ":" commentsBefore[] | "commentsAfter" ":" commentsAfter[] | "name" ":" name['"','"'] | "metamodel" ":" metamodel[] | "elements" ":" elements[] | "model" ":" model[])* "}";
}