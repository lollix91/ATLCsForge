 ...
 */
public interface IAtlTextParser extends atl.resource.atl.IAtlConfigurable {
	 ...
	 */
	public atl.resource.atl.IAtlParseResult parse();
	 ...
	 * will not be needed.
	 */
	public java.util.List<atl.resource.atl.mopp.AtlExpectedTerminal> parseToExpectedElements(org.eclipse.emf.ecore.EClass type, atl.resource.atl.IAtlTextResource dummyResource, int cursorOffset);
