...
/**
 * A IAtlReferenceResolverSwitch holds references to multiple other reference
 * resolvers and delegates requests to the appropriate resolver.
 */
public interface IAtlReferenceResolverSwitch extends atl.resource.atl.IAtlConfigurable {
