 ...
 */
public interface IAtlOptions {
	
	/**
	 * The key for the option to provide a stream pre-processor.
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new atl.resource.atl.mopp.AtlMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new atl.resource.atl.mopp.AtlMetaInformation().getResourcePostProcessorProviderOptionKey();
