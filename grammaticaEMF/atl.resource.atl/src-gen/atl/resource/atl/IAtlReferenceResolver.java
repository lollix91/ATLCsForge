 ...
 * resolver
 */
public interface IAtlReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends atl.resource.atl.IAtlConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, atl.resource.atl.IAtlReferenceResolveResult<ReferenceType> result);
