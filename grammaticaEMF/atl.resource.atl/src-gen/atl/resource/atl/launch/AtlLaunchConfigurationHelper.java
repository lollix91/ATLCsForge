 ...
 * 
 */
package atl.resource.atl.launch;

/**
 * A class that provides common methods that are required by launch configuration
 * delegates.
 */
public class AtlLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends atl.resource.atl.util.AbstractAtlInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, atl.resource.atl.util.AbstractAtlInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final atl.resource.atl.debug.AtlDebuggableInterpreter<ResultType, ContextType> interpreter = new atl.resource.atl.debug.AtlDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		atl.resource.atl.debug.AtlDebuggerListener<ResultType, ContextType> debugListener = new atl.resource.atl.debug.AtlDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		atl.resource.atl.debug.AtlDebugProcess process = new atl.resource.atl.debug.AtlDebugProcess(launch);
		launch.addDebugTarget(new atl.resource.atl.debug.AtlDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(atl.resource.atl.launch.AtlLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return atl.resource.atl.util.AtlResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, atl.resource.atl.mopp.AtlPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
