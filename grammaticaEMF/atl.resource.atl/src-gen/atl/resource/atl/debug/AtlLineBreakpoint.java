...
public class AtlLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "atl.resource.atl.debug.lineBreakpoint.marker";
	
	public AtlLineBreakpoint() {
		super();
	}
	
	public AtlLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(atl.resource.atl.debug.AtlDebugTarget target) {
		try {
	...
	public void remove(atl.resource.atl.debug.AtlDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
