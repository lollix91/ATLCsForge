...
public class AtlStackFrame extends atl.resource.atl.debug.AtlDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private atl.resource.atl.debug.AtlDebugTarget target;
	private String name;
	private int id;
	...
	public AtlStackFrame(atl.resource.atl.debug.AtlDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = atl.resource.atl.util.AtlStringUtil.decode(data, ',');
	...
	private atl.resource.atl.debug.AtlDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		atl.resource.atl.debug.AtlStackFrame other = (atl.resource.atl.debug.AtlStackFrame) obj;
		if (name == null) {
