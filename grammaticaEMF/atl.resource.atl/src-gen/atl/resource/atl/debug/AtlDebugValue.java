...
public class AtlDebugValue extends atl.resource.atl.debug.AtlDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public AtlDebugValue(atl.resource.atl.debug.AtlDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
