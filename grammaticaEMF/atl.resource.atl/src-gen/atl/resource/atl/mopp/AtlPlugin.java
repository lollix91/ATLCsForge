 ...
 */
public class AtlPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "atl.resource.atl";
	/**
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, AtlPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, AtlPlugin.PLUGIN_ID, message);
		}
		final AtlPlugin pluginInstance = AtlPlugin.getDefault();
