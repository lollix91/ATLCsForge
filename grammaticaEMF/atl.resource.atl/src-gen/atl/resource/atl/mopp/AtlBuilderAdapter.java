...
public class AtlBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "atl.resource.atl.builder";
	
	private atl.resource.atl.IAtlBuilder defaultBuilder = new atl.resource.atl.mopp.AtlBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		atl.resource.atl.IAtlBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			atl.resource.atl.mopp.AtlResource customResource = (atl.resource.atl.mopp.AtlResource) resourceSet.getResource(uri, true);
			new atl.resource.atl.mopp.AtlMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public atl.resource.atl.IAtlBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new atl.resource.atl.mopp.AtlMarkerHelper().getMarkerID(atl.resource.atl.AtlEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		atl.resource.atl.mopp.AtlTaskItemBuilder taskItemBuilder = new atl.resource.atl.mopp.AtlTaskItemBuilder();
		new atl.resource.atl.mopp.AtlMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new atl.resource.atl.mopp.AtlMetaInformation().getSyntaxName())) {
