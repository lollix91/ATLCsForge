 ...
 */
public class AtlExpectedTerminal {
	...
	private atl.resource.atl.IAtlExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	private atl.resource.atl.grammar.AtlContainmentTrace containmentTrace;
	
	public AtlExpectedTerminal(org.eclipse.emf.ecore.EObject container, atl.resource.atl.IAtlExpectedElement terminal, int followSetID, atl.resource.atl.grammar.AtlContainmentTrace containmentTrace) {
		super();
	...
	public atl.resource.atl.IAtlExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		...
		AtlExpectedTerminal otherExpectedTerminal = (AtlExpectedTerminal) o;
	...
	public atl.resource.atl.grammar.AtlContainmentTrace getContainmentTrace() {
