...
public class AtlNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "atl.resource.atl.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {atl.resource.atl.mopp.AtlBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(atl.resource.atl.mopp.AtlBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
