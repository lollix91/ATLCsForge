...
/**
 * A AtlLayoutInformationAdapter is used to store layout information that is found
 ...
 * AtlLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class AtlLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<atl.resource.atl.mopp.AtlLayoutInformation> layoutInformations = new java.util.ArrayList<atl.resource.atl.mopp.AtlLayoutInformation>();
	...
	public java.util.List<atl.resource.atl.mopp.AtlLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(atl.resource.atl.mopp.AtlLayoutInformation layoutInformation) {
