...
/**
 * AtlLayoutInformation objects are used to store layout information that is found
 ...
 * AtlLayoutInformations are aggregated in LayoutInformationAdapters. One
 * AtlLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class AtlLayoutInformation {
	 ...
	 */
	private final atl.resource.atl.grammar.AtlSyntaxElement syntaxElement;
	...
	public AtlLayoutInformation(atl.resource.atl.grammar.AtlSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public atl.resource.atl.grammar.AtlSyntaxElement getSyntaxElement() {
