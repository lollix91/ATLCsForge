 ...
 * given name.
 */
public class AtlReferenceCache extends org.eclipse.emf.common.notify.impl.AdapterImpl implements atl.resource.atl.IAtlReferenceCache {
	...
	private atl.resource.atl.IAtlNameProvider nameProvider;
	
	public AtlReferenceCache(atl.resource.atl.IAtlNameProvider nameProvider) {
		super();
