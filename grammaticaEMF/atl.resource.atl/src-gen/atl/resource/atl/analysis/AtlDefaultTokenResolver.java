 ...
 */
public class AtlDefaultTokenResolver implements atl.resource.atl.IAtlTokenResolver {
	 ...
	 */
	public AtlDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public AtlDefaultTokenResolver(boolean escapeKeywords) {
		super();
		this.escapeKeywords = escapeKeywords;
	}
	
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, atl.resource.atl.IAtlTokenResolveResult result) {
		resolve(lexem, feature, result, null, null, null);
	}
	
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, atl.resource.atl.IAtlTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : atl.resource.atl.grammar.AtlGrammarInformationProvider.INSTANCE.getKeywords()) {
