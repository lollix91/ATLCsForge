...
public class AtlPropertyTester extends org.eclipse.core.expressions.PropertyTester {
	...
	private boolean hasMatchingURI(org.eclipse.core.resources.IResource resource) {
		...
		return path.endsWith("." + new atl.resource.atl.mopp.AtlMetaInformation().getSyntaxName());
	}
