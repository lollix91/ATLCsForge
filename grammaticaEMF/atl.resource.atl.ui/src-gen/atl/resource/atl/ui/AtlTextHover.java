 ...
 */
public class AtlTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private atl.resource.atl.IAtlHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final atl.resource.atl.ui.AtlBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(atl.resource.atl.ui.AtlBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			atl.resource.atl.ui.AtlDocBrowserInformationControlInput infoInput = (atl.resource.atl.ui.AtlDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					atl.resource.atl.ui.AtlHyperlink hyperlink = new atl.resource.atl.ui.AtlHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (atl.resource.atl.ui.AtlBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				atl.resource.atl.ui.AtlBrowserInformationControl iControl = new atl.resource.atl.ui.AtlBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof atl.resource.atl.ui.AtlDocBrowserInformationControlInput) {
							atl.resource.atl.ui.AtlDocBrowserInformationControlInput input = (atl.resource.atl.ui.AtlDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (atl.resource.atl.ui.AtlBrowserInformationControl.isAvailable(parent)) {
				atl.resource.atl.ui.AtlBrowserInformationControl iControl = new atl.resource.atl.ui.AtlBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public AtlTextHover(atl.resource.atl.IAtlResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new atl.resource.atl.ui.AtlUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((atl.resource.atl.ui.AtlDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private atl.resource.atl.ui.AtlDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private atl.resource.atl.ui.AtlDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, atl.resource.atl.ui.AtlDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				atl.resource.atl.ui.AtlHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			atl.resource.atl.ui.AtlHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			atl.resource.atl.ui.AtlHTMLPrinter.insertPageProlog(buffer, 0, atl.resource.atl.ui.AtlTextHover.getStyleSheet());
			atl.resource.atl.ui.AtlHTMLPrinter.addPageEpilog(buffer);
			return new atl.resource.atl.ui.AtlDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = atl.resource.atl.ui.AtlHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(atl.resource.atl.ui.AtlUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return atl.resource.atl.util.AtlStreamUtil.getContent(styleSheetURL.openStream());
