 ...
 */
public class AtlPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(atl.resource.atl.ui.AtlUIPlugin.getDefault().getPreferenceStore());
		setDescription("Atl Text Editor Preferences");
	}
