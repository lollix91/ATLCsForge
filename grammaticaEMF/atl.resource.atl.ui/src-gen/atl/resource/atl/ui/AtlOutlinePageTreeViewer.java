 ...
 * a specified depth.
 */
public class AtlOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public AtlOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = atl.resource.atl.util.AtlStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof atl.resource.atl.ui.AtlEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			atl.resource.atl.mopp.AtlPlugin.logError("Exception while refreshing outline view", e);
		}
	}
