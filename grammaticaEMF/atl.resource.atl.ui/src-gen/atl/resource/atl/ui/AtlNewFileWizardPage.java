 ...
 */
public class AtlNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public AtlNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new atl file");
