 ...
 */
public class AtlLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new atl.resource.atl.mopp.AtlMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(atl.resource.atl.launch.AtlLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			atl.resource.atl.mopp.AtlPlugin.logError("Exception while launching selection", e);
		}
	}
