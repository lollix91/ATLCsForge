 ...
 * olInput</code>.
 */
public class AtlDocBrowserInformationControlInput {
	
	private final AtlDocBrowserInformationControlInput fPrevious;
	private AtlDocBrowserInformationControlInput fNext;
	 ...
	 */
	public AtlDocBrowserInformationControlInput(AtlDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public AtlDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public AtlDocBrowserInformationControlInput getNext() {
		return fNext;
	}
