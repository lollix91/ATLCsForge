 ...
 */
public class AtlHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public AtlHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				atl.resource.atl.mopp.AtlPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
