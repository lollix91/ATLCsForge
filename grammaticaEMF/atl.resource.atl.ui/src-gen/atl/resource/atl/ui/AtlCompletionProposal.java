 ...
 */
public class AtlCompletionProposal implements java.lang.Comparable<AtlCompletionProposal> {
	 ...
	 */
	private atl.resource.atl.mopp.AtlExpectedTerminal expectedTerminal;
	...
	public AtlCompletionProposal(atl.resource.atl.mopp.AtlExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public AtlCompletionProposal(atl.resource.atl.mopp.AtlExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public AtlCompletionProposal(atl.resource.atl.mopp.AtlExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public atl.resource.atl.mopp.AtlExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof AtlCompletionProposal) {
			AtlCompletionProposal other = (AtlCompletionProposal) object;
	...
	public int compareTo(AtlCompletionProposal object) {
		if (object instanceof AtlCompletionProposal) {
			AtlCompletionProposal other = (AtlCompletionProposal) object;
