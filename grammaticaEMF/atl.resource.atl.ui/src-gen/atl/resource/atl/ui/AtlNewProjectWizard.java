 ...
 */
public class AtlNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new atl.resource.atl.mopp.AtlMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("atl.resource.atl.ui");
							...
							String natureID = atl.resource.atl.mopp.AtlNature.NATURE_ID;
							...
							for (String builderID : atl.resource.atl.mopp.AtlNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								atl.resource.atl.mopp.AtlMetaInformation info = new atl.resource.atl.mopp.AtlMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = atl.resource.atl.ui.AtlUIPlugin.getDefault().getBundle();
