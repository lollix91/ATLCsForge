 ...
 */
public class AtlCodeFoldingManager {
	
	private class FoldingUpdateListener implements atl.resource.atl.IAtlBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(atl.resource.atl.ui.AtlEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof atl.resource.atl.ui.AtlEditor) {
				atl.resource.atl.ui.AtlEditor editor = (atl.resource.atl.ui.AtlEditor) workbenchPart;
	...
	protected atl.resource.atl.ui.AtlEditor editor;
	 ...
	 */
	public AtlCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,atl.resource.atl.ui.AtlEditor textEditor) {
	...
	private void addCloseListener(final atl.resource.atl.ui.AtlEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			atl.resource.atl.ui.AtlUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		atl.resource.atl.IAtlTextResource textResource = (atl.resource.atl.IAtlTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
