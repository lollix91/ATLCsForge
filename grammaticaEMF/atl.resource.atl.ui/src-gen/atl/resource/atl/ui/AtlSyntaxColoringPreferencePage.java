 ...
 */
public class AtlSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public AtlSyntaxColoringPreferencePage() {
		super();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = atl.resource.atl.ui.AtlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, atl.resource.atl.ui.AtlSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = atl.resource.atl.ui.AtlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, atl.resource.atl.ui.AtlSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = atl.resource.atl.ui.AtlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, atl.resource.atl.ui.AtlSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = atl.resource.atl.ui.AtlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, atl.resource.atl.ui.AtlSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = atl.resource.atl.ui.AtlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, atl.resource.atl.ui.AtlSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = atl.resource.atl.ui.AtlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, atl.resource.atl.ui.AtlSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		atl.resource.atl.ui.AtlPixelConverter pixelConverter = new atl.resource.atl.ui.AtlPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof atl.resource.atl.ui.AtlEditor) {
			atl.resource.atl.ui.AtlEditor emfTextEditor = (atl.resource.atl.ui.AtlEditor) editor;
