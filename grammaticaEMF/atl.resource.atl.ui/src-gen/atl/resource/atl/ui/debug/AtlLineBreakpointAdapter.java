...
public class AtlLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(atl.resource.atl.mopp.AtlPlugin.DEBUG_MODEL_ID);
			...
			atl.resource.atl.debug.AtlLineBreakpoint lineBreakpoint = new atl.resource.atl.debug.AtlLineBreakpoint(resource, lineNumber + 1);
