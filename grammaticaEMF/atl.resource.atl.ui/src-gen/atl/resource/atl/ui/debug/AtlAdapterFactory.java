 ...
 * 
 */
package atl.resource.atl.ui.debug;

@SuppressWarnings("restriction")
public class AtlAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new atl.resource.atl.mopp.AtlMetaInformation().getSyntaxName())) {
					return new atl.resource.atl.ui.debug.AtlLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof atl.resource.atl.debug.AtlDebugVariable) {
			final atl.resource.atl.debug.AtlDebugVariable variable = (atl.resource.atl.debug.AtlDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof atl.resource.atl.debug.AtlDebugVariable) {
			final atl.resource.atl.debug.AtlDebugVariable variable = (atl.resource.atl.debug.AtlDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							atl.resource.atl.debug.AtlDebugValue castedValue = (atl.resource.atl.debug.AtlDebugValue) value;
