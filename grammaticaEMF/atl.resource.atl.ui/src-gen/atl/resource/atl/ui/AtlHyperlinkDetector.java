 ...
 * hovers, is a proxy.
 */
public class AtlHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public AtlHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (atl.resource.atl.IAtlTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new atl.resource.atl.ui.AtlHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
