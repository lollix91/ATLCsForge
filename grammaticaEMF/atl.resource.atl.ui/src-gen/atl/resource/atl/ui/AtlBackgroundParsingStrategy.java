 ...
 */
public class AtlBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final atl.resource.atl.IAtlTextResource resource, final atl.resource.atl.ui.AtlEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final atl.resource.atl.IAtlTextResource resource, final atl.resource.atl.ui.AtlEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final atl.resource.atl.IAtlTextResource resource, final atl.resource.atl.ui.AtlEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof atl.resource.atl.mopp.AtlResource) {
							atl.resource.atl.mopp.AtlResource concreteResource = (atl.resource.atl.mopp.AtlResource) resource;
