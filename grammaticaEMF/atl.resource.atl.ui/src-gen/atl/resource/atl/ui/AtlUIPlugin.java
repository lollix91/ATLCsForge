 ...
 */
public class AtlUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "atl.resource.atl.ui";
	public static final String EDITOR_ID = "atl.resource.atl.ui.AtlEditor";
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, AtlUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, AtlUIPlugin.PLUGIN_ID, message);
		}
		final AtlUIPlugin pluginInstance = AtlUIPlugin.getDefault();
