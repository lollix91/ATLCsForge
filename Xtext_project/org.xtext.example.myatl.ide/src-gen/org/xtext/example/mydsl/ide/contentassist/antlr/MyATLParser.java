		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTypeLiteralExpCSAccess().getGroup(), "rule__TypeLiteralExpCS__Group__0");
					...
					put(grammarAccess.getHelperAccess().getDefinitionAssignment_2(), "rule__Helper__DefinitionAssignment_2");
					...
					put(grammarAccess.getCollectionTypeCSAccess().getBacktrackAssignment_2(), "rule__CollectionTypeCS__BacktrackAssignment_2");
					...
					put(grammarAccess.getCollectionLiteralExpCSAccess().getBacktrackAssignment_4(), "rule__CollectionLiteralExpCS__BacktrackAssignment_4");
					...
					put(grammarAccess.getCollectionLiteralPartCSAccess().getBacktrackAssignment_2(), "rule__CollectionLiteralPartCS__BacktrackAssignment_2");
					...
					put(grammarAccess.getTypeLiteralExpCSAccess().getOwnedTypeAssignment_0(), "rule__TypeLiteralExpCS__OwnedTypeAssignment_0");
					put(grammarAccess.getTypeLiteralExpCSAccess().getBacktrackAssignment_1(), "rule__TypeLiteralExpCS__BacktrackAssignment_1");
