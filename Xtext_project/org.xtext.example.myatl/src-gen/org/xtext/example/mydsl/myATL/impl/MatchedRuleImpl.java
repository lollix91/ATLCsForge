 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myATL.impl.MatchedRuleImpl#getName <em>Name</em>}</li>
...
public class MatchedRuleImpl extends ModuleElementImpl implements MatchedRule
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyATLPackage.MATCHED_RULE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyATLPackage.MATCHED_RULE__NAME:
        return getName();
      case MyATLPackage.MATCHED_RULE__IN_PATTERN:
        return getInPattern();
      case MyATLPackage.MATCHED_RULE__VARIABLES:
