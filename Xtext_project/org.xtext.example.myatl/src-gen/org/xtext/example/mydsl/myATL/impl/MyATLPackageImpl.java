...
public class MyATLPackageImpl extends EPackageImpl implements MyATLPackage
{
   ...
   * @generated
   */
  public EAttribute getMatchedRule_Name()
  {
    return (EAttribute)matchedRuleEClass.getEStructuralFeatures().get(0);
  }
  ...
  {
    return (EReference)matchedRuleEClass.getEStructuralFeatures().get(4);
  }
   ...
   * @generated
   */
  public EAttribute getCalledRule_Name()
  {
    return (EAttribute)calledRuleEClass.getEStructuralFeatures().get(0);
  }
  ...
  {
    return (EReference)calledRuleEClass.getEStructuralFeatures().get(3);
  }
   ...
   * @generated
   */
  public EAttribute getCollectionTypeCS_Backtrack()
  {
    return (EAttribute)collectionTypeCSEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EAttribute getCollectionLiteralExpCS_Backtrack()
  {
    return (EAttribute)collectionLiteralExpCSEClass.getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EAttribute getCollectionLiteralPartCS_Backtrack()
  {
    return (EAttribute)collectionLiteralPartCSEClass.getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EAttribute getTypeLiteralExpCS_Backtrack()
  {
    return (EAttribute)typeLiteralExpCSEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(matchedRuleEClass, MATCHED_RULE__NAME);
    ...
    createEAttribute(calledRuleEClass, CALLED_RULE__NAME);
    ...
    createEAttribute(collectionTypeCSEClass, COLLECTION_TYPE_CS__BACKTRACK);
    ...
    createEAttribute(collectionLiteralExpCSEClass, COLLECTION_LITERAL_EXP_CS__BACKTRACK);
    ...
    createEAttribute(collectionLiteralPartCSEClass, COLLECTION_LITERAL_PART_CS__BACKTRACK);
    ...
    createEAttribute(typeLiteralExpCSEClass, TYPE_LITERAL_EXP_CS__BACKTRACK);
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getMatchedRule_Name(), ecorePackage.getEString(), "name", null, 0, 1, MatchedRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getCalledRule_Name(), ecorePackage.getEString(), "name", null, 0, 1, CalledRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getCollectionTypeCS_Backtrack(), ecorePackage.getEString(), "backtrack", null, 0, 1, CollectionTypeCS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getCollectionLiteralExpCS_Backtrack(), ecorePackage.getEString(), "backtrack", null, 0, 1, CollectionLiteralExpCS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getCollectionLiteralPartCS_Backtrack(), ecorePackage.getEString(), "backtrack", null, 0, 1, CollectionLiteralPartCS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getTypeLiteralExpCS_Backtrack(), ecorePackage.getEString(), "backtrack", null, 0, 1, TypeLiteralExpCS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getNavigatingBarArgCS_Name(), this.getExpCS(), null, "name", null, 0, 1, NavigatingBarArgCS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getNavigatingCommaArgCS_Name(), this.getExpCS(), null, "name", null, 0, 1, NavigatingCommaArgCS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getNavigatingSemiArgCS_Name(), this.getExpCS(), null, "name", null, 0, 1, NavigatingSemiArgCS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
