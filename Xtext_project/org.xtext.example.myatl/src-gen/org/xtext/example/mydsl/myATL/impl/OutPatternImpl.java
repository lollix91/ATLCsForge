 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myATL.impl.OutPatternImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OutPatternImpl extends MinimalEObjectImpl.Container implements OutPattern
{
  ...
  {
    return MyATLPackage.Literals.OUT_PATTERN;
  }
  ...
  public EList<OutPatternElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<OutPatternElement>(OutPatternElement.class, this, MyATLPackage.OUT_PATTERN__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyATLPackage.OUT_PATTERN__ELEMENTS:
