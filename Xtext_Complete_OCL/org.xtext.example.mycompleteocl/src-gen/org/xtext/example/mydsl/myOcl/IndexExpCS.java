 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myOcl.IndexExpCS#getFirstIndexes <em>First Indexes</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myOcl.IndexExpCS#getSecondIndexes <em>Second Indexes</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.mydsl.myOcl.MyOclPackage#getIndexExpCS()
 * @model
 * @generated
 */
public interface IndexExpCS extends NavigatingExpCS_Base
{
   ...
   * The list contents are of type {@link org.xtext.example.mydsl.myOcl.ExpCS}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.xtext.example.mydsl.myOcl.MyOclPackage#getIndexExpCS_FirstIndexes()
   ...
   * @see org.xtext.example.mydsl.myOcl.MyOclPackage#getIndexExpCS_SecondIndexes()
   * @model containment="true"
   * @generated
   */
