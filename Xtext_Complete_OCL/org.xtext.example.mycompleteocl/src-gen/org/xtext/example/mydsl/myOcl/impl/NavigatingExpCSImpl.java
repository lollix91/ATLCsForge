 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myOcl.impl.NavigatingExpCSImpl#getNamedExp <em>Named Exp</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myOcl.impl.NavigatingExpCSImpl#getArgument <em>Argument</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NavigatingExpCSImpl extends PrimaryExpCSImpl implements NavigatingExpCS
{
  ...
  {
    return MyOclPackage.Literals.NAVIGATING_EXP_CS;
  }
  ...
  public NotificationChain basicSetNamedExp(NavigatingExpCS_Base newNamedExp, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyOclPackage.NAVIGATING_EXP_CS__NAMED_EXP, oldNamedExp, newNamedExp);
  ...
  public void setNamedExp(NavigatingExpCS_Base newNamedExp)
  {
    if (newNamedExp != namedExp)
    {
      ...
      if (namedExp != null)
        msgs = ((InternalEObject)namedExp).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyOclPackage.NAVIGATING_EXP_CS__NAMED_EXP, null, msgs);
      if (newNamedExp != null)
        msgs = ((InternalEObject)newNamedExp).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyOclPackage.NAVIGATING_EXP_CS__NAMED_EXP, null, msgs);
      msgs = basicSetNamedExp(newNamedExp, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyOclPackage.NAVIGATING_EXP_CS__NAMED_EXP, newNamedExp, newNamedExp));
  }
  ...
  public EList<EObject> getArgument()
  {
    if (argument == null)
    {
      argument = new EObjectContainmentEList<EObject>(EObject.class, this, MyOclPackage.NAVIGATING_EXP_CS__ARGUMENT);
    }
    return argument;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyOclPackage.NAVIGATING_EXP_CS__NAMED_EXP:
        return basicSetNamedExp(null, msgs);
      case MyOclPackage.NAVIGATING_EXP_CS__ARGUMENT:
