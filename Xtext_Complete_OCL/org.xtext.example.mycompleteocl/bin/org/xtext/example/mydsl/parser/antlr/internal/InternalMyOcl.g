...
entryRuleUnrestrictedName2 returns [String current=null]:
	{ newCompositeNode(grammarAccess.getUnrestrictedName2Rule()); }
	iv_ruleUnrestrictedName2=ruleUnrestrictedName2
	{ $current=$iv_ruleUnrestrictedName2.current.getText(); }
	EOF;

// Rule UnrestrictedName2
ruleUnrestrictedName2 returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_LetExpCS_5.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_IfExpCS_6.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_NestedExpCS_7.current;
			afterParserOrEnumRuleCall();
		}
	)
;
