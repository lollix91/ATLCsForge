 ...
 */
package org.xtext.example.mycompleteocl.ui.internal;
 ...
 * introduced subclass. 
 */
public class MycompleteoclActivator extends AbstractUIPlugin {

	public static final String ORG_XTEXT_EXAMPLE_MYDSL_MYOCL = "org.xtext.example.mydsl.MyOcl";
	
	private static final Logger logger = Logger.getLogger(MycompleteoclActivator.class);
	
	private static MycompleteoclActivator INSTANCE;
	...
	public static MycompleteoclActivator getInstance() {
		return INSTANCE;
	}
