...
:
	...
	|
	(
		{ before(grammarAccess.getPrimaryExpCSAccess().getLetExpCSParserRuleCall_5()); }
		ruleLetExpCS
		{ after(grammarAccess.getPrimaryExpCSAccess().getLetExpCSParserRuleCall_5()); }
	)
	|
	(
		{ before(grammarAccess.getPrimaryExpCSAccess().getIfExpCSParserRuleCall_6()); }
		ruleIfExpCS
		{ after(grammarAccess.getPrimaryExpCSAccess().getIfExpCSParserRuleCall_6()); }
	)
	|
	(
		{ before(grammarAccess.getPrimaryExpCSAccess().getNestedExpCSParserRuleCall_7()); }
		ruleNestedExpCS
		{ after(grammarAccess.getPrimaryExpCSAccess().getNestedExpCSParserRuleCall_7()); }
	)
;
finally {
	restoreStackSize(stackSize);
