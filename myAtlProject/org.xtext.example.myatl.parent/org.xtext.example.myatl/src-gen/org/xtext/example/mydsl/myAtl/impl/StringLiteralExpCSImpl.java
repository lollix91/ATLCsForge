 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myAtl.impl.StringLiteralExpCSImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringLiteralExpCSImpl extends PrimitiveLiteralExpCSImpl implements StringLiteralExpCS
{
  ...
  {
    return MyAtlPackage.Literals.STRING_LITERAL_EXP_CS;
  }
  ...
  public EList<String> getName()
  {
    if (name == null)
    {
      name = new EDataTypeEList<String>(String.class, this, MyAtlPackage.STRING_LITERAL_EXP_CS__NAME);
    }
    return name;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyAtlPackage.STRING_LITERAL_EXP_CS__NAME:
        return getName();
    }
