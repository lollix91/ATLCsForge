...
import org.xtext.example.mydsl.web.MyAtlWebSetup;
...
public class MyAtlServlet extends XtextServlet {
  ...
  public void init() {
    try {
      super.init();
      final Injector injector = new MyAtlWebSetup().createInjectorAndDoEMFRegistration();
